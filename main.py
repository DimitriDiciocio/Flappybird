...
def main(genomas, config):
    ...
    if aiJogando:
        ...
        lista_genomas = []  # Adicione uma lista vazia para evitar o erro quando a IA não está jogando
        redes = []  # Também adicione redes vazias
    ...
    while rodando:
        ...
        for i, passaro in enumerate(passaros):
            ...
            if aiJogando:  # Só usar a IA se estiver jogando
